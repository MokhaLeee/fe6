...
EVENT_COMMANDS = {
    ...
    0x01: "EVT_CMD_KILL",
    0x02: "EVT_CMD_SLEEP",
    0x03: "EVT_CMD_BACKGROUND",
    0x04: "EVT_CMD_BACKGROUNDMORE",
    0x05: "EVT_CMD_CLEARTALK",
    0x06: "EVT_CMD_CLEARSKIP",
    0x07: "EVT_CMD_TALK",
    0x08: "EVT_CMD_TALKMORE",
    0x09: "EVT_CMD_TALKAUTO",
    0x0A: "EVT_CMD_TALKCONT",
    0x0B: "EVT_CMD_CAMERA_POS",
    0x0C: "EVT_CMD_CAMERA_PID",
    0x0D: "EVT_CMD_MOVE_POS",
    0x0E: "EVT_CMD_MOVE_POS_MANUAL",
    0x0F: "EVT_CMD_MOVE_PID",
    0x10: "EVT_CMD_MOVE_PID_MANUAL",
    0x11: "EVT_CMD_MOVE_PID_NEXTTO",
    0x12: "EVT_CMD_LOADUNITS",
    0x13: "EVT_CMD_LOADUNITS_PARTY",
    0x14: "EVT_CMD_MOVEWAIT",
    0x15: "EVT_CMD_UNITCAM_ON",
    0x16: "EVT_CMD_UNITCAM_OFF",
    0x17: "EVT_CMD_FUNC",
    0x18: "EVT_CMD_FUNC_UNTIL",
    0x19: "EVT_CMD_FUNC_WHILE",
    0x1A: "EVT_CMD_STOP",
    0x1B: "EVT_CMD_LABEL",
    0x1C: "EVT_CMD_GOTO",
    0x1D: "EVT_CMD_GOTO_IFN_ALIVE",
    0x1E: "EVT_CMD_GOTO_IFN_INTEAM",
    0x1F: "EVT_CMD_GOTO_IFY_FUNC",
    0x20: "EVT_CMD_GOTO_IFN_FUNC",
    0x21: "EVT_CMD_GOTO_IFY_SKIPPED",
    0x22: "EVT_CMD_GOTO_IFY_FLAG",
    0x23: "EVT_CMD_GOTO_IFN_FLAG",
    0x24: "EVT_CMD_GOTO_IFY_ACTIVE",
    0x25: "EVT_CMD_JUMP",
    0x26: "EVT_CMD_ITEM",
    0x27: "EVT_CMD_ITEM_PID",
    0x28: "EVT_CMD_MONEY",
    0x29: "EVT_CMD_MAPCHANGE",
    0x2A: "EVT_CMD_MAPCHANGE_POS",
    0x2B: "EVT_CMD_FACTION",
    0x2C: "EVT_CMD_FLASHCURSOR_POS",
    0x2D: "EVT_CMD_FLASHCURSOR_PID",
    0x2E: "EVT_CMD_CURSOR",
    0x2F: "EVT_CMD_CLEARCURSOR",
    0x30: "EVT_CMD_REMOVEUNIT",
    0x31: "EVT_CMD_REMOVEUNIT_DISPLAYED",
    0x32: "EVT_CMD_SETAI_PID",
    0x33: "EVT_CMD_SETAI_POS",
    0x34: "EVT_CMD_SETFLAG",
    0x35: "EVT_CMD_CLEARFLAG",
    0x36: "EVT_CMD_BGM",
    0x37: "EVT_CMD_BGM_OVERRIDE",
    0x38: "EVT_CMD_BGM_RESTORE",
    0x39: "EVT_CMD_BGM_FADEOUT",
    0x3A: "EVT_CMD_BGM_LOWER_ON",
    0x3B: "EVT_CMD_BGM_LOWER_OFF",
    0x3C: "EVT_CMD_SE",
    0x3D: "EVT_CMD_CHAPTER",
    0x3E: "EVT_CMD_GAMEEND",
    0x3F: "EVT_CMD_SETMAP",
    0x40: "EVT_CMD_NOSKIP",
    0x41: "EVT_CMD_NOSKIP_NOTEXTSKIP",
    0x42: "EVT_CMD_YESSKIP",
    0x43: "EVT_CMD_FADE_TOBLACK",
    0x44: "EVT_CMD_FADE_FROMBLACK",
    0x45: "EVT_CMD_FADE_TOWHITE",
    0x46: "EVT_CMD_FADE_FROMWHITE",
    0x47: "EVT_CMD_EXIT_MAP",
    0x48: "EVT_CMD_ENTER_MAP",
    0x49: "EVT_CMD_FIGHTSCR",
    0x4A: "EVT_CMD_NOCLEARTALK",
    0x4B: "EVT_CMD_FUNC_ONSKIP",
    0x4C: "EVT_CMD_WEATHER",
    0x4D: "EVT_CMD_WM_START",
    0x4E: "EVT_CMD_WM_END",
    0x4F: "EVT_CMD_WM_ZOOMTO",
    0x50: "EVT_CMD_WM_ZOOMBACK",
    0x51: "EVT_CMD_WM_PUTFACE",
    0x52: "EVT_CMD_WM_REMOVEFACE",
    0x53: "EVT_CMD_WM_MOVEFACE",
    0x54: "EVT_CMD_WM_NOP54",
    0x55: "EVT_CMD_WM_NOP55",
    0x56: "EVT_CMD_WM_TALK",
    0x57: "EVT_CMD_WM_TALKBOX_BOTTOM",
    0x58: "EVT_CMD_WM_TALKBOX_TOP",
    0x59: "EVT_CMD_WM_TALKBOX_REMOVE",
    0x5A: "EVT_CMD_WM_ARROW",
    0x5B: "EVT_CMD_WM_HIGHLIGHT",
    0x5C: "EVT_CMD_WM_HIGHLIGHT_REMOVE",
    0x5D: "EVT_CMD_WM_HIGHLIGHT_REMOVEBOTH",
    0x5E: "EVT_CMD_WM_DOT",
    0x5F: "EVT_CMD_WM_DOT_REMOVE",
    0x60: "EVT_CMD_WM_FLAG",
    0x61: "EVT_CMD_WM_FLAG_REMOVE",
    0x62: "EVT_CMD_WM_MAPTEXT",
    0x63: "EVT_CMD_WM_MAPTEXT_REMOVE",
}
...
UNIT_SPRITES = {
    0x00: "UNITSPRITE_ROY",
    0x01: "UNITSPRITE_MERCENARY",
    0x02: "UNITSPRITE_MERCENARY_F",
    0x03: "UNITSPRITE_HERO",
    0x04: "UNITSPRITE_HERO_F",
    0x05: "UNITSPRITE_MYRMIDON",
    0x06: "UNITSPRITE_MYRMIDON_F",
    0x07: "UNITSPRITE_SWORDMASTER",
    0x08: "UNITSPRITE_SWORDMASTER_F",
    0x09: "UNITSPRITE_FIGHTER",
    0x0A: "UNITSPRITE_WARRIOR",
    0x0B: "UNITSPRITE_ARMOR",
    0x0C: "UNITSPRITE_GENERAL",
    0x0D: "UNITSPRITE_ARCHER",
    0x0E: "UNITSPRITE_ARCHER_F",
    0x0F: "UNITSPRITE_SNIPER",
    0x10: "UNITSPRITE_SNIPER_F",
    0x11: "UNITSPRITE_PRIEST",
    0x12: "UNITSPRITE_CLERIC",
    0x13: "UNITSPRITE_BISHOP",
    0x14: "UNITSPRITE_BISHOP_F",
    0x15: "UNITSPRITE_MAGE",
    0x16: "UNITSPRITE_MAGE_F",
    0x17: "UNITSPRITE_SAGE",
    0x18: "UNITSPRITE_SAGE_F",
    0x19: "UNITSPRITE_SHAMAN",
    0x1A: "UNITSPRITE_SHAMAN_F",
    0x1B: "UNITSPRITE_DRUID",
    0x1C: "UNITSPRITE_DRUID_F",
    0x1D: "UNITSPRITE_CAVALIER",
    0x1E: "UNITSPRITE_CAVALIER_F",
    0x1F: "UNITSPRITE_PALADIN",
    0x20: "UNITSPRITE_PALADIN_F",
    0x21: "UNITSPRITE_TROUBADOUR",
    0x22: "UNITSPRITE_VALKYRIE",
    0x23: "UNITSPRITE_NOMAD",
    0x24: "UNITSPRITE_NOMAD_F",
    0x25: "UNITSPRITE_NOMADTROOPER",
    0x26: "UNITSPRITE_NOMADTROOPER_F",
    0x27: "UNITSPRITE_PEGASUSKNIGHT",
    0x28: "UNITSPRITE_FALCONKNIGHT",
    0x29: "UNITSPRITE_WYVERNRIDER",
    0x2A: "UNITSPRITE_WYVERNLORD",
    0x2B: "UNITSPRITE_SOLDIER",
    0x2C: "UNITSPRITE_BRIGAND",
    0x2D: "UNITSPRITE_PIRATE",
    0x2E: "UNITSPRITE_BERSERKER",
    0x2F: "UNITSPRITE_THIEF",
    0x30: "UNITSPRITE_THIEF_F",
    0x31: "UNITSPRITE_BARD",
    0x32: "UNITSPRITE_DANCER",
    0x33: "UNITSPRITE_MANAKETE",
    0x34: "UNITSPRITE_FAE",
    0x35: "UNITSPRITE_FIREDRAGON",
    0x36: "UNITSPRITE_DIVINEDRAGON",
    0x37: "UNITSPRITE_DEMONDRAGON",
    0x38: "UNITSPRITE_KING",
    0x39: "UNITSPRITE_CIVILIAN",
    0x3A: "UNITSPRITE_CIVILIAN_F",
    0x3B: "UNITSPRITE_CHILD",
    0x3C: "UNITSPRITE_CHILD_F",
    0x3D: "UNITSPRITE_SUPPLY",
    0x3E: "UNITSPRITE_ROY_PROMOTED",
    0x3F: "UNITSPRITE_ARCHER_BALLISTA",
    0x40: "UNITSPRITE_ARCHER_LONGBALLISTA",
    0x41: "UNITSPRITE_ARCHER_KILLERBALLISTA",
    0x42: "UNITSPRITE_BALLISTA",
    0x43: "UNITSPRITE_LONGBALLISTA",
    0x44: "UNITSPRITE_KILLERBALLISTA",
    0x45: "UNITSPRITE_DISMOUNTED",
    0x46: "UNITSPRITE_DISMOUNTED_F",
}

MANIM_FACINGS = {
    0x00: "MANIM_FACING_OPPONENT",
    0x01: "MANIM_FACING_DEFAULT",
    0x02: "MANIM_FACING_UNKNOWN",
}
