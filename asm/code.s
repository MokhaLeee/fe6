...
.L0808DD84:
	...
	ldr r5, .L0808DE00 @ =unk_02016A2E
	ldr r4, .L0808DDF8 @ =gpAuguryBuf
	ldr r1, [r4]
	lsls r0, r0, #0x18
	lsrs r0, r0, #0x18
	adds r1, #0x6c
...
.L0808DDE2:
	...
	bx r0
	.align 2, 0
.L0808DDF8: .4byte gpAuguryBuf
.L0808DDFC: .4byte gUnk_0868B490
.L0808DE00: .4byte unk_02016A2E
...
func_fe6_0808DF3C: @ 0x0808DF3C
	...
	lsls r6, r6, #0x10
	lsrs r6, r6, #0x10
	ldr r0, .L0808DF70 @ =Pal_08342AD8
	movs r1, #0xe0
	lsls r1, r1, #2
	movs r2, #0x20
	bl ApplyPaletteExt
	ldr r0, .L0808DF74 @ =ProcScr_0868B5E8
	movs r1, #3
	bl SpawnProc
	strh r4, [r0, #0x36]
	strh r5, [r0, #0x32]
	...
	bx r0
	.align 2, 0
.L0808DF70: .4byte Pal_08342AD8
.L0808DF74: .4byte ProcScr_0868B5E8

	thumb_func_start func_fe6_0808DF78
func_fe6_0808DF78: @ 0x0808DF78
	push {lr}
	adds r3, r0, #0
	ldr r0, .L0808DFB8 @ =gpAuguryBuf
	ldr r0, [r0]
	mov ip, r0
	lsls r2, r3, #1
	adds r0, #0x5e
...
.L0808E27C:
	...
	bx r0
	.align 2, 0
.L0808E280: .4byte gpAuguryBuf

	thumb_func_start func_fe6_0808E284
func_fe6_0808E284: @ 0x0808E284
	push {r4, lr}
	adds r1, r0, #0
	ldr r0, .L0808E2C8 @ =ProcScr_0868B610
	bl SpawnProcLocking
	ldr r2, .L0808E2CC @ =gpAuguryBuf
	ldr r1, [r2]
	adds r1, #0x9f
	ldrb r1, [r1]
	adds r3, r0, #0
	...
	bx r0
	.align 2, 0
.L0808E2C8: .4byte ProcScr_0868B610
.L0808E2CC: .4byte gpAuguryBuf

	thumb_func_start func_fe6_0808E2D0
func_fe6_0808E2D0: @ 0x0808E2D0
	push {lr}
	adds r1, r0, #0
	ldr r0, .L0808E2EC @ =gpAuguryBuf
	ldr r0, [r0]
	adds r0, #0x9f
	ldrb r0, [r0]
	cmp r0, #5
...
func_fe6_0808E2F4: @ 0x0808E2F4
	...
	adds r3, r4, #0
	bl SetObjAffine
	ldr r0, .L0808E38C @ =ProcScr_0868B648
	movs r1, #3
	bl SpawnProc
	add sp, #4
	pop {r3, r4}
...
.L0808E38C: .4byte ProcScr_0868B648
...
.L0808E414:
	...
	bx r0
	.align 2, 0
.L0808E41C: .4byte gpAuguryBuf

	thumb_func_start func_fe6_0808E420
func_fe6_0808E420: @ 0x0808E420
	movs r1, #0
	strh r1, [r0, #0x2a]
	ldr r1, .L0808E430 @ =unk_02016A28
	ldrh r1, [r1]
	subs r1, #1
	strh r1, [r0, #0x2c]
	bx lr
	.align 2, 0
.L0808E430: .4byte unk_02016A28
...
.L0808E5CC:
	...
	bx r0
	.align 2, 0
.L0808E5DC: .4byte unk_02016A28
.L0808E5E0: .4byte gUnk_0868B5B0
.L0808E5E4: .4byte unk_02016A2A
...
func_fe6_0808F780: @ 0x0808F780
	push {lr}
	ldr r0, .L0808F78C @ =BgConfig_0868B7F4
	bl InitBgs
	pop {r0}
	bx r0
	.align 2, 0
.L0808F78C: .4byte BgConfig_0868B7F4

	thumb_func_start func_fe6_0808F790
func_fe6_0808F790: @ 0x0808F790
	push {lr}
	adds r1, r0, #0
	ldr r0, .L0808F7AC @ =gpAuguryBuf
	ldr r0, [r0]
	adds r0, #0x9f
	ldrb r0, [r0]
	cmp r0, #2
...
func_fe6_0808FD44: @ 0x0808FD44
	...
	cmp r1, #0
	bne .L0808FD5C
	ldr r0, .L0808FD58 @ =ProcScr_0868B8E4
	movs r1, #3
	bl SpawnProc
	b .L0808FD62
	.align 2, 0
.L0808FD58: .4byte ProcScr_0868B8E4
.L0808FD5C:
	ldr r0, .L0808FD68 @ =ProcScr_0868B8E4
	bl SpawnProcLocking
.L0808FD62:
	pop {r0}
	bx r0
	.align 2, 0
.L0808FD68: .4byte ProcScr_0868B8E4
...
.L08090ED0:
	...
	ldr r0, .L08090ED8 @ =ProcScr_0868B8E4
	b .L08090EC2
	.align 2, 0
.L08090ED8: .4byte ProcScr_0868B8E4
.L08090EDC:
	movs r0, #0x36
	movs r1, #0
	bl StartBgm
