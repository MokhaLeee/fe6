...
.L0807EB9A:
	...
	cmp r3, r2
	bhs .L0807EC46
	ldr r7, .L0807ED7C @ =gPrepItemListData
...
.L0807EC8C:
	...
	ldrb r0, [r0]
	movs r4, #0
	ldr r7, [sp, #0x28] @ convoy_page
	strb r0, [r7]
	ldrb r0, [r7]
	bl func_fe6_0807D834
	ldr r1, [sp, #0x30] @ unk_4E
	ldrh r0, [r1]
	movs r5, #0
	mov r2, r8 @ menu_scroll_bar_disp_idx
	strh r0, [r2]

	ldr r3, [sp, #0x2c] @ unk_47
	ldrb r0, [r3]
	ldr r7, [sp, #0x14] @ hand_disp_y
	strb r0, [r7]
	ldr r0, [sp, #0x14]
	mov r1, r8
	...
	ldr r2, [sp, #0x24] @ convoy_scrolling_pos
	strb r5, [r2]
	movs r0, #1
	ldr r3, [sp, #0x18] @ hand_disp_x
	strb r0, [r3]
	movs r0, #0xff
	ldr r4, [sp, #0x1c] @ unk30
	ldrb r1, [r4]
	orrs r1, r0
	strb r1, [r4]
	ldr r7, [sp, #0x20] @ sel_action
	ldrb r7, [r7]
	orrs r0, r7
	ldr r1, [sp, #0x20]
	strb r0, [r1]
	...
	ldr r2, .L0807ED7C @ =gPrepItemListData
	mov r3, r8
	ldrh r3, [r3]
	lsrs r1, r3, #4
	ldr r4, [sp, #0x14]
	...
	movs r0, #0xf
	bl EnableBgSync
	ldr r0, [sp, #0xc] @ menu_scrolling_pos
	strb r5, [r0]
	ldr r1, [sp, #0x10] @ unk2D
	ldrb r0, [r1]
	cmp r0, #0
	bne .L0807ED8C
	movs r1, #1
...
.L0807ED7C: .4byte gPrepItemListData
