	...
	thumb_func_start WmMapTextDisp_Loop1
WmMapTextDisp_Loop1: @ 0x08093D54
	push {r4, r5, r6, lr}
	sub sp, #8
	adds r5, r0, #0
	ldr r0, [r5, #0x50]
...
.L08093DD0: .4byte gDispIo
	...
	thumb_func_start WmMapTextDisp_Loop2
WmMapTextDisp_Loop2: @ 0x08093DD4
	push {r4, r5, r6, lr}
	sub sp, #8
	adds r5, r0, #0
	ldr r0, [r5, #0x50]
...
.L08093E0C:
	...
	thumb_func_start WmMapTextDisp_Loop3
WmMapTextDisp_Loop3: @ 0x08093E14
	push {r4, r5, r6, lr}
	sub sp, #8
	adds r5, r0, #0
	ldr r0, [r5, #0x50]
...
.L08093E8C: .4byte gDispIo
	...
	thumb_func_start WmMapTextDisp_End
WmMapTextDisp_End: @ 0x08093E90
	push {r4, lr}
	adds r4, r0, #0
	adds r0, #0x6a
	movs r1, #0
