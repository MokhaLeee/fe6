	...
	thumb_func_start NewEfxArrow
NewEfxArrow: @ 0x0804D62C
	push {r4, r5, lr}
	adds r5, r0, #0
	bl SpellFx_Begin
	bl SpellFx_SetBG1Position
	ldr r0, .L0804D660 @ =ProcScr_EfxArrow
	movs r1, #3
	bl SpawnProc
	adds r4, r0, #0
	str r5, [r4, #0x5c]
	...
	bx r0
	.align 2, 0
.L0804D660: .4byte ProcScr_EfxArrow

	thumb_func_start EfxArrow_Loop
EfxArrow_Loop: @ 0x0804D664
	push {r4, r5, r6, lr}
	adds r5, r0, #0
	ldr r0, [r5, #0x5c]
