...
.L0807D3A6:
	...
	cmp r0, #0
	beq .L0807D3D8
	ldr r2, .L0807D460 @ =gPrep_Unk_02015D28
	mov r0, r8
	adds r0, #0x50
	ldrh r0, [r0]
	lsrs r0, r0, #4
...
.L0807D3E6:
	...
	cmp r4, r6
	bhs .L0807D424
	ldr r6, .L0807D460 @ =gPrep_Unk_02015D28
.L0807D3F8:
	lsls r0, r4, #2
	adds r0, r0, r6
	ldrh r0, [r0, #2]
...
.L0807D460: .4byte gPrep_Unk_02015D28
...
func_fe6_0807D834: @ 0x0807D834
	...
	adds r6, r1, #0
.L0807D866:
	ldr r1, .L0807D8B8 @ =gPrep_Unk_02015D28
	lsls r0, r4, #2
	adds r5, r0, r1
	ldrh r0, [r5, #2]
	bl GetItemKind
...
.L0807D8B8: .4byte gPrep_Unk_02015D28
.L0807D8BC:
	lsls r0, r2, #1
	adds r0, r0, r2
	adds r2, r0, #1
...
.L0807D95C:
	...
	mov sb, r2
.L0807D976:
	ldr r1, .L0807D9E0 @ =gPrep_Unk_02015D28
	lsls r0, r4, #2
	adds r5, r0, r1
	ldrh r0, [r5, #2]
	bl GetItemKind
...
.L0807D9A8:
	...
	blt .L0807D976
.L0807D9B2:
	ldr r0, .L0807D9E0 @ =gPrep_Unk_02015D28
	ldr r1, .L0807D9D0 @ =gPrepTexts4
	movs r2, #0xc8
	lsls r2, r2, #3
	bl memcpy
...
.L0807D9E0: .4byte gPrep_Unk_02015D28
...
.L0807DA5C:
	...
	adds r4, r4, r0
	ldr r0, .L0807DAD0 @ =gPrep_Unk_02015D28
	mov r1, r8
	lsls r5, r1, #2
	adds r7, r5, r0
	ldrh r0, [r7, #2]
...
.L0807DAD0: .4byte gPrep_Unk_02015D28
.L0807DAD4:
	movs r2, #0
.L0807DAD6:
	movs r0, #7
...
.L0807DAEC:
	adds r0, r7, #0
	bl Text_SetColor
	ldr r0, .L0807DB74 @ =gPrep_Unk_02015D28
	adds r5, r5, r0
	ldrh r0, [r5, #2]
	bl GetItemName
	adds r1, r0, #0
...
.L0807DB5E:
	...
	bx r0
	.align 2, 0
.L0807DB74: .4byte gPrep_Unk_02015D28
...
func_fe6_0807DB80: @ 0x0807DB80
	...
	lsls r4, r4, #1
	adds r4, r4, r6
	ldr r1, .L0807DC18 @ =gPrep_Unk_02015D28
	mov r2, r8
	lsls r0, r2, #2
	adds r5, r0, r1
	ldrh r0, [r5, #2]
...
.L0807DC18: .4byte gPrep_Unk_02015D28
.L0807DC1C:
	movs r2, #0
.L0807DC1E:
	movs r0, #7
...
.L0807DC34:
	...
	movs r1, #0
	bl Text_SetCursor
	ldr r1, .L0807DCB0 @ =gPrep_Unk_02015D28
	mov r2, r8
	lsls r0, r2, #2
	adds r0, r0, r1
	mov r8, r0
...
.L0807DC88:
	...
	bx r0
	.align 2, 0
.L0807DCB0: .4byte gPrep_Unk_02015D28
...
func_fe6_0807DE60: @ 0x0807DE60
	...
	cmp r2, r1
	bhs .L0807DE9C
	ldr r6, .L0807DEC4 @ =gPrep_Unk_02015D28
	adds r5, r0, #0
.L0807DE78:
	lsls r0, r3, #2
	adds r1, r0, r6
...
.L0807DEC4: .4byte gPrep_Unk_02015D28
...
func_fe6_0807DF60: @ 0x0807DF60
	...
	lsls r2, r2, #0x10
	lsrs r5, r2, #0x10
	ldr r6, .L0807DFD4 @ =gPrep_Unk_02015D28
	lsls r4, r5, #2
	adds r4, r4, r6
	ldr r3, [r4]
	lsrs r1, r1, #0x17
...
.L0807DFC0:
	...
	b .L0807DFE6
	.align 2, 0
.L0807DFD4: .4byte gPrep_Unk_02015D28
...
.L0807E0F4:
	...
	adds r2, #0x12
	str r2, [sp, #0x30]
	ldr r2, .L0807E2B8 @ =gPrepSubMenuIcons
	movs r1, #0xff
.L0807E182:
	lsls r0, r4, #2
	adds r0, r0, r2
...
.L0807E1E8:
	...
	cmp r4, #7
	bls .L0807E1E8
	ldr r0, .L0807E2D4 @ =Pal_SpinningArrow
	movs r1, #0x90
	lsls r1, r1, #2
	movs r2, #0x60
	bl ApplyPaletteExt
	...
	cmp r3, #3
	bhi .L0807E300
	ldr r0, .L0807E2F0 @ =Img_Prep_0831AB1C
	ldr r1, .L0807E2F4 @ =0x06011000
	bl Decompress
	ldr r0, .L0807E2F8 @ =Img_Prep_083198CC
...
.L0807E2B8: .4byte gPrepSubMenuIcons
.L0807E2BC: .4byte gBg0Tm
.L0807E2C0: .4byte gBg1Tm
.L0807E2C4: .4byte gBg2Tm
.L0807E2C8: .4byte gPrepTexts3
.L0807E2CC: .4byte gPrepTexts1
.L0807E2D0: .4byte gPrepTexts2
...
.L0807E2F0: .4byte Img_Prep_0831AB1C
.L0807E2F4: .4byte 0x06011000
.L0807E2F8: .4byte Img_Prep_083198CC
.L0807E2FC: .4byte 0x06017200
.L0807E300:
	ldr r0, .L0807E40C @ =Img_Prep_083198CC
...
.L0807E3F0:
	...
	bx r0
	.align 2, 0
.L0807E40C: .4byte Img_Prep_083198CC
.L0807E410: .4byte 0x06015000
.L0807E414: .4byte gPrepTexts3
...
PrepSubItem_StartTradeScreen: @ 0x0807E41C
	...
	movs r3, #0xc
	bl PutUiWindowFrame
	ldr r4, .L0807E4B8 @ =gPrepTexts3 + 0x8
	adds r0, r4, #0
	bl ClearText
	adds r0, r4, #0
	movs r1, #0
	...
	b .L0807E4C6
	.align 2, 0
.L0807E4B8: .4byte gPrepTexts3 + 0x8
...
.L0807EB9A:
	...
	cmp r3, r2
	bhs .L0807EC46
	ldr r7, .L0807ED7C @ =gPrep_Unk_02015D28
...
.L0807EC8C:
	...
	ldr r2, .L0807ED7C @ =gPrep_Unk_02015D28
	mov r3, r8
	ldrh r3, [r3]
	lsrs r1, r3, #4
	ldr r4, [sp, #0x14]
...
.L0807ED7C: .4byte gPrep_Unk_02015D28
...
.L0807F10C:
	...
	ldr r0, [r3, #0x54]
	ldrb r1, [r6]
	ldr r3, .L0807F168 @ =gPrep_Unk_02015D28
	mov r2, r8
	adds r2, #0x50
	ldrh r2, [r2]
	lsrs r2, r2, #4
...
.L0807F168: .4byte gPrep_Unk_02015D28
...
.L0807F180:
	...
	ldr r2, .L0807F22C @ =gPrep_Unk_02015D28
	ldrh r4, [r4]
	lsrs r1, r4, #4
	ldrb r3, [r6]
	adds r1, r3, r1
...
.L0807F22C: .4byte gPrep_Unk_02015D28
.L0807F230:
...
.L0807F364:
	ldr r2, .L0807F3D8 @ =gPrep_Unk_02015D28
	mov r1, r8
	adds r1, #0x2e
	mov r0, r8
	adds r0, #0x50
...
.L0807F392:
	...
	b .L0807F3E2
	.align 2, 0
.L0807F3D8: .4byte gPrep_Unk_02015D28
...
.L0807F466:
	...
	subs r3, #0x48
	subs r1, r1, r3
	ldr r4, .L0807F4A0 @ =gPrep_Unk_02015D28
	mov r3, r8
	adds r3, #0x50
	ldrh r3, [r3]
	lsrs r3, r3, #4
...
.L0807F4A0: .4byte gPrep_Unk_02015D28
.L0807F4A4:
...
.L0807F4E4:
	...
	mov r0, r8
	bl func_fe6_0807D358
	ldr r1, .L0807F554 @ =gPrep_Unk_02015D28
	ldrh r2, [r5]
	lsrs r0, r2, #4
	ldrb r6, [r6]
	adds r0, r6, r0
...
.L0807F554: .4byte gPrep_Unk_02015D28
...
.L0807F55C:
	...
	subs r0, #1
	strb r0, [r6]
	ldr r1, .L0807F5C4 @ =gPrep_Unk_02015D28
	mov r0, r8
	adds r0, #0x50
	ldrh r0, [r0]
	lsrs r0, r0, #4
...
.L0807F5BA:
	...
	b .L0807FA9A
	.align 2, 0
.L0807F5C4: .4byte gPrep_Unk_02015D28
...
.L0807F5FE:
	...
	mov r0, r8
	bl func_fe6_0807D358
	ldr r1, .L0807F670 @ =gPrep_Unk_02015D28
	ldrh r2, [r5]
	lsrs r0, r2, #4
	ldrb r6, [r6]
	adds r0, r6, r0
...
.L0807F670: .4byte gPrep_Unk_02015D28
...
.L0807F690:
	...
	adds r0, #1
	strb r0, [r4]
	ldr r1, .L0807F704 @ =gPrep_Unk_02015D28
	ldrh r5, [r5]
	lsrs r0, r5, #4
	ldrb r4, [r4]
	adds r0, r4, r0
...
.L0807F6FA:
	...
	b .L0807FA9A
	.align 2, 0
.L0807F704: .4byte gPrep_Unk_02015D28
...
.L0807F8BE:
	...
	movs r2, #0xc
	bl PutUiEntryHover
	ldr r1, .L0807F964 @ =gPrep_Unk_02015D28
	ldrh r5, [r5]
	lsrs r0, r5, #4
	ldrb r4, [r4]
	adds r0, r4, r0
...
.L0807F964: .4byte gPrep_Unk_02015D28
...
.L0807F9B0:
	...
	movs r2, #0xc
	bl PutUiEntryHover
	ldr r1, .L0807FA78 @ =gPrep_Unk_02015D28
	ldrh r4, [r4]
	lsrs r0, r4, #4
	ldrb r5, [r5]
	adds r0, r5, r0
...
.L0807FA78: .4byte gPrep_Unk_02015D28
...
.L0807FB24:
	...
	subs r3, #0x48
	subs r1, r1, r3
	ldr r4, .L0807FBC8 @ =gPrep_Unk_02015D28
	ldrh r5, [r5]
	lsrs r3, r5, #4
	adds r2, r2, r3
	lsls r2, r2, #2
...
.L0807FB52:
	...
	b .L0807FBD6
	.align 2, 0
.L0807FBC8: .4byte gPrep_Unk_02015D28
...
PrepSubItem_StartSupplyScreen: @ 0x0807FCFC
	...
	cmp r0, #0
	beq .L0807FD9C
	ldr r0, .L0807FDC0 @ =gPrep_Unk_02015D28
	mov ip, r0
	movs r7, #0
	adds r4, r1, #0
.L0807FD72:
...
.L0807FDC0: .4byte gPrep_Unk_02015D28
.L0807FDC4:
	movs r0, #0
.L0807FDC6:
	strb r0, [r5]
...
.L0807FEE0:
	...
	movs r1, #7
	bl Proc_Goto
	ldr r1, .L0807FF48 @ =gPrep_Unk_02015D28
	mov r2, sb
	ldrh r2, [r2]
	lsrs r0, r2, #4
	mov r3, sl
...
.L0807FF48: .4byte gPrep_Unk_02015D28
...
.L080801B0:
	...
	movs r3, #0
	bl TmFillRect_thm
	ldr r1, .L0808021C @ =gPrep_Unk_02015D28
	adds r0, r5, #0
	adds r0, #0x50
	ldrh r0, [r0]
	lsrs r0, r0, #4
...
.L0808021C: .4byte gPrep_Unk_02015D28
.L08080220:
	ldr r1, [r7]
	movs r0, #0x80
	lsls r0, r0, #1
...
.L0808052E:
	...
	cmp r0, r2
	bge .L08080588
	ldr r3, .L080805E4 @ =gPrep_Unk_02015D28
.L0808056E:
	asrs r1, r1, #0x10
	lsls r2, r1, #2
	adds r2, r2, r3
...
.L080805E4: .4byte gPrep_Unk_02015D28
...
.L0808062E:
	...
	movs r3, #0
	bl TmFillRect_thm
	ldr r1, .L080806A8 @ =gPrep_Unk_02015D28
	mov r4, r8
	ldrh r4, [r4]
	lsrs r0, r4, #4
	ldrb r5, [r7]
...
.L080806A8: .4byte gPrep_Unk_02015D28
...
.L080807F0:
	...
	cmp r1, r0
	blt .L08080842
	ldr r0, .L080808D0 @ =gPrep_Unk_02015D28
	mov sl, r0
	movs r1, #0
	mov sb, r1
.L08080820:
	...
	bge .L08080820
.L08080842:
	ldr r3, .L080808D0 @ =gPrep_Unk_02015D28
	mov r0, r8
	ldrh r0, [r0]
	lsrs r1, r0, #4
	lsls r1, r1, #2
...
.L080808D0: .4byte gPrep_Unk_02015D28
...
.L08080952:
	...
	adds r0, r2, r0
	lsls r0, r0, #2
	ldr r3, .L08080A0C @ =gPrep_Unk_02015D28
	adds r0, r0, r3
	ldrh r0, [r0, #2]
	strh r0, [r1]
	ldr r0, [r6, #0x54]
...
.L08080A0C: .4byte gPrep_Unk_02015D28
...
.L08080A48:
	...
	cmp r0, #0
	beq .L08080B3C
	ldr r1, .L08080A98 @ =gPrep_Unk_02015D28
	mov r3, r8
	ldrh r3, [r3]
	lsrs r0, r3, #4
	ldrb r4, [r7]
...
.L08080A98: .4byte gPrep_Unk_02015D28
...
.L08080BFA:
	...
	subs r2, #0x48
	subs r1, r1, r2
	ldr r2, .L08080C30 @ =gPrep_Unk_02015D28
	mov ip, r2
	ldrh r3, [r3]
	lsrs r2, r3, #4
	adds r2, r2, r4
...
.L08080C30: .4byte gPrep_Unk_02015D28
.L08080C34:
	adds r0, r6, #0
	adds r0, #0x2f
	ldrb r2, [r0]
...
.L0808136C:
	...
	subs r2, #0x48
	subs r1, r1, r2
	ldr r3, .L080813E4 @ =gPrep_Unk_02015D28
	lsls r2, r5, #2
	adds r2, r2, r3
	ldrh r2, [r2, #2]
	bl StartItemHelpBox
...
.L08081392:
	...
	cmp r1, #2
	bne .L080813B6
	ldr r1, .L080813E4 @ =gPrep_Unk_02015D28
	mov r2, r8
	ldrh r2, [r2]
	lsrs r0, r2, #4
	ldrb r7, [r7]
...
.L080813D2:
	...
	bx r0
	.align 2, 0
.L080813E4: .4byte gPrep_Unk_02015D28
...
func_fe6_080813E8: @ 0x080813E8
	...
	subs r1, #7
	strb r0, [r1]
	ldr r5, .L0808145C @ =gPrep_Unk_02015D28
	ldrh r1, [r3]
	lsrs r0, r1, #4
	ldrb r1, [r2]
	adds r0, r1, r0
	...
	b .L08081536
	.align 2, 0
.L0808145C: .4byte gPrep_Unk_02015D28
.L08081460:
	adds r1, r4, #0
	adds r1, #0x2f
	ldrb r0, [r1]
...
.L08081486:
	...
	adds r0, #0x39
	strb r1, [r0]
	ldr r7, .L080814FC @ =gPrep_Unk_02015D28
	adds r5, r4, #0
	adds r5, #0x2e
	adds r6, r4, #0
	adds r6, #0x50
...
.L080814FC: .4byte gPrep_Unk_02015D28
.L08081500:
	ldrb r0, [r1]
	bl GetUnitByPid
	str r0, [r4, #0x58]
