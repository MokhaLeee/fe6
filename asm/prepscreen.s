...
.L0807C0DA:
	...
	movs r0, #0xd
	movs r2, #4
	ldr r3, .L0807C124 @ =Sprite_0867917A
	bl PutSprite
	adds r4, #1
	cmp r4, #7
	ble .L0807C0DA
...
.L0807C124: .4byte Sprite_0867917A
.L0807C128:
	movs r0, #0
.L0807C12A:
	strb r0, [r4]
...
.L0807C1A8:
	...
	ands r1, r5
	ldr r3, .L0807C1E8 @ =Sprite_08679182
	movs r4, #0x80
	lsls r4, r4, #6
	str r4, [sp]
	movs r0, #0xd
...
.L0807C1E8: .4byte Sprite_08679182
.L0807C1EC:
	movs r1, #0xa0
	lsls r1, r1, #1
	add r1, r8
	ands r1, r5
	ldr r3, .L0807C204 @ =Sprite_086791B0
	str r4, [sp]
	movs r0, #0xd
	movs r2, #8
	bl PutSprite
	b .L0807C23E
	.align 2, 0
.L0807C204: .4byte Sprite_086791B0
.L0807C208:
	ldr r0, [r1, #0x60]
	adds r4, r6, #0
	adds r4, #0x48
...
.L0807C24E:
	...
	ands r1, r0
	ldr r3, .L0807C284 @ =Sprite_086791BE
	movs r0, #0x80
	lsls r0, r0, #7
	str r0, [sp]
	movs r0, #4
...
.L0807C284: .4byte Sprite_086791BE
...
.L0807CC24: .4byte gPlaySt
	...
	thumb_func_start ResetPrepMenuItem
ResetPrepMenuItem: @ 0x0807CC28
	ldr r1, .L0807CC30 @ =gPrepMenuItemCnt
	movs r0, #0
	strb r0, [r1]
	bx lr
	.align 2, 0
.L0807CC30: .4byte gPrepMenuItemCnt

	thumb_func_start SetPrepScreenMenuItem
SetPrepScreenMenuItem: @ 0x0807CC34
	push {r4, r5, r6, r7, lr}
	adds r5, r0, #0
	adds r6, r2, #0
	ldr r0, [sp, #0x18]
	...
	lsrs r0, r0, #0x18
	mov ip, r0
	ldr r3, .L0807CCBC @ =gPrepMenuItemCnt
	ldrb r0, [r3]
	cmp r0, #0xf
	bhi .L0807CCB4
	ldr r2, .L0807CCC0 @ =gPrepMenuItems
	lsls r0, r0, #2
	ldrb r7, [r3]
	adds r0, r0, r7
	lsls r0, r0, #2
...
PrepMenuOnSelected: @ 0x0807CCC4
	...
	movs r5, #0
	movs r3, #0
	ldr r0, .L0807CD04 @ =gPrepMenuItemCnt
	adds r6, r0, #0
	ldrb r0, [r6]
	cmp r3, r0
	bge .L0807CD1C
	adds r2, r4, #0
	adds r2, #0x35
	ldr r1, .L0807CD08 @ =gPrepMenuItems
.L0807CCDC:
	ldrb r7, [r1, #9]
	ldrb r0, [r2]
	cmp r7, r0
	...
	b .L0807CD1E
	.align 2, 0
.L0807CD04: .4byte gPrepMenuItemCnt
.L0807CD08: .4byte gPrepMenuItems
.L0807CD0C:
	adds r0, r5, #1
	lsls r0, r0, #0x18
	lsrs r5, r0, #0x18
...
GetPrepMenuItemAmount: @ 0x0807CD24
	...
	lsrs r4, r0, #0x18
	movs r3, #0
	ldr r0, .L0807CD54 @ =gPrepMenuItemCnt
	ldrb r0, [r0]
	cmp r3, r0
	bge .L0807CD4C
	ldr r2, .L0807CD58 @ =gPrepMenuItems
	adds r1, r0, #0
.L0807CD38:
	ldrb r0, [r2, #9]
	cmp r0, r4
...
.L0807CD4C:
	...
	bx r1
	.align 2, 0
.L0807CD54: .4byte gPrepMenuItemCnt
.L0807CD58: .4byte gPrepMenuItems

	thumb_func_start PutPrepScreenMenuItems
PutPrepScreenMenuItems: @ 0x0807CD5C
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
	...
	mov r8, r0
	movs r7, #0
	ldr r0, .L0807CDEC @ =gPrepMenuItemCnt
	ldrb r0, [r0]
	cmp r7, r0
	bge .L0807CDDC
	ldr r0, .L0807CDF0 @ =gPrepMenuItems
	adds r5, r0, #0
	adds r5, #8
	adds r6, r2, #0
.L0807CD8A:
...
PrepMenuHelpbox: @ 0x0807CDF4
	...
	mov sl, r0
	movs r4, #0
	ldr r0, .L0807CE4C @ =gPrepMenuItemCnt
	mov sb, r0
	ldrb r1, [r0]
	cmp r4, r1
	bge .L0807CE8A
	ldr r7, .L0807CE50 @ =gPrepMenuItems
	mov ip, r7
	mov r3, r8
	adds r3, #0x35
	mov r6, ip
...
.L0807CE1C:
	...
	b .L0807CE68
	.align 2, 0
.L0807CE4C: .4byte gPrepMenuItemCnt
.L0807CE50: .4byte gPrepMenuItems
.L0807CE54:
	ldrb r1, [r1]
	lsls r1, r1, #4
	adds r1, #0x48
...
func_fe6_0807CE98: @ 0x0807CE98
	...
	movs r4, #0
	movs r2, #0
	ldr r0, .L0807CED0 @ =gPrepMenuItemCnt
	ldrb r1, [r0]
	cmp r2, r1
	bge .L0807CEE6
	ldr r0, .L0807CED4 @ =gPrepMenuItems
	adds r3, r5, #0
	adds r3, #0x35
	ldrb r6, [r3]
	mov ip, r6
...
.L0807CEBA:
	...
	b .L0807CEE8
	.align 2, 0
.L0807CED0: .4byte gPrepMenuItemCnt
.L0807CED4: .4byte gPrepMenuItems
.L0807CED8:
	adds r0, r4, #1
	lsls r0, r0, #0x18
	lsrs r4, r0, #0x18
...
func_fe6_0807CEF0: @ 0x0807CEF0
	...
	lsrs r1, r1, #0x18
	movs r2, #0
	ldr r3, .L0807CF14 @ =gPrepMenuItemCnt
	ldrb r0, [r3]
	cmp r2, r0
	bge .L0807CF26
	ldr r0, .L0807CF18 @ =gPrepMenuItems
	adds r0, #8
.L0807CF08:
	ldrb r5, [r0, #8]
	cmp r5, r4
	...
	b .L0807CF26
	.align 2, 0
.L0807CF14: .4byte gPrepMenuItemCnt
.L0807CF18: .4byte gPrepMenuItems
.L0807CF1C:
	adds r0, #0x14
	adds r2, #1
	ldrb r5, [r3]
...
func_fe6_0807CF2C: @ 0x0807CF2C
	...
	movs r1, #0
	movs r3, #0
	ldr r0, .L0807CF58 @ =gPrepMenuItemCnt
	ldrb r2, [r0]
	cmp r3, r2
	bge .L0807CF6E
	ldr r0, .L0807CF5C @ =gPrepMenuItems
	adds r4, r2, #0
	adds r2, r0, #0
	adds r2, #9
.L0807CF4A:
	...
	b .L0807CF70
	.align 2, 0
.L0807CF58: .4byte gPrepMenuItemCnt
.L0807CF5C: .4byte gPrepMenuItems
.L0807CF60:
	adds r0, r1, #1
	lsls r0, r0, #0x18
	lsrs r1, r0, #0x18
