...
.L0807D382:
	...
	blo .L0807D382
.L0807D3A6:
	ldr r6, .L0807D45C @ =gUnk_0201636A
	ldrh r0, [r6]
	cmp r0, #0
	beq .L0807D3D8
...
.L0807D3F8:
	...
	cmp r4, r0
	bge .L0807D424
	ldr r0, .L0807D45C @ =gUnk_0201636A
	ldrh r0, [r0]
	cmp r4, r0
	blo .L0807D3F8
.L0807D424:
...
func_fe6_0807D4A8: @ 0x0807D4A8
	...
	adds r0, #0x44
	bl ClearText
	ldr r0, .L0807D4FC @ =gUnk_0201636A
	ldrh r0, [r0]
	cmp r0, #0
	bne .L0807D508
...
func_fe6_0807D834: @ 0x0807D834
	...
	lsrs r0, r0, #0x18
	mov sl, r0
	ldr r1, .L0807D8A8 @ =gUnk_0201636A
	movs r0, #0
	strh r0, [r1]
	movs r4, #0
...
.L0807D8BC:
	...
	adds r2, r0, #1
.L0807D8C2:
	ldr r1, .L0807D8E0 @ =gUnk_0201636A
	ldrh r0, [r1]
	movs r1, #3
	str r2, [sp]
	bl __udivsi3
...
.L0807D944:
	mov r4, sb
.L0807D946:
	ldr r0, .L0807D9D4 @ =gUnk_0201636A
	ldrh r0, [r0]
	cmp r4, r0
	blt .L0807D8E4
	adds r0, r2, #0
...
func_fe6_0807D9E4: @ 0x0807D9E4
	...
	movs r1, #0
	bl TmFill
	ldr r6, .L0807DAC8 @ =gUnk_0201636A
	ldrh r0, [r6]
	cmp r0, #0
	bne .L0807DA40
	mov r0, sl
...
.L0807DB32:
	...
	cmp r8, r0
	bge .L0807DB5E
	ldr r0, .L0807DB7C @ =gUnk_0201636A
	ldrh r0, [r0]
	cmp r8, r0
	bhs .L0807DB5E
	b .L0807DA5C
...
func_fe6_0807DCB8: @ 0x0807DCB8
	...
	movs r3, #0
	bl TmFillRect_thm
	ldr r0, .L0807DD08 @ =gUnk_0201636A
	ldrh r0, [r0]
	cmp r0, #0
	bne .L0807DD0C
	mov r0, sb
...
func_fe6_0807DF60: @ 0x0807DF60
	...
	adds r4, r0, #0
	ldr r7, .L0807DFDC @ =gUnk_0201636A
	ldrh r0, [r4]
	cmp r2, r0
	bhs .L0807DFC0
	adds r3, r6, #0
...
.L0807EC8C:
	...
	ldrh r1, [r7]
	str r1, [sp]
	ldr r1, .L0807ED88 @ =gUnk_0201636A
	ldrh r1, [r1]
	str r1, [sp, #4]
	movs r1, #7
	str r1, [sp, #8]
...
.L0807F322:
	...
	cmp r0, #0
	bne .L0807F410
	ldr r0, .L0807F35C @ =gUnk_0201636A
	ldrh r0, [r0]
	cmp r0, #0
	bne .L0807F364
...
.L0807F448:
	...
	cmp r0, #0
	bne .L0807F4A4
	ldr r0, .L0807F49C @ =gUnk_0201636A
	ldrh r0, [r0]
	cmp r0, #0
	bne .L0807F466
	b .L0807FA9A
...
.L0807F5F0:
	...
	b .L0807F710
.L0807F5FE:
	ldr r3, .L0807F668 @ =gUnk_0201636A
	cmp r1, #5
	bne .L0807F678
	mov r5, r8
	adds r5, #0x50
...
.L0807F8BE:
	...
	cmp r4, r0
	bne .L0807F940
	ldr r0, .L0807F968 @ =gUnk_0201636A
	ldrh r0, [r0]
	cmp r0, #0
	bne .L0807F94C
.L0807F940:
...
.L0807F9B0:
	...
	cmp r4, r0
	bne .L0807FA50
	ldr r0, .L0807FA7C @ =gUnk_0201636A
	ldrh r0, [r0]
	cmp r0, #0
	bne .L0807FA5C
.L0807FA50:
...
.L0807FADA:
	...
	b .L0807FB52
.L0807FB0C:
	ldr r0, .L0807FB20 @ =gUnk_0201636A
	ldrh r0, [r0]
	cmp r0, #0
	bne .L0807FB24
	cmp r2, #1
...
func_fe6_0807FBE8: @ 0x0807FBE8
	...
	ldrh r1, [r4]
	str r1, [sp]
	ldr r1, .L0807FCF8 @ =gUnk_0201636A
	ldrh r1, [r1]
	str r1, [sp, #4]
	movs r1, #7
	str r1, [sp, #8]
...
.L0808052E:
	...
	adds r5, r4, #0
	ldr r2, .L080805E0 @ =gUnk_0201636A
	mov ip, r2
	adds r3, r6, #0
	adds r3, #0x4b
	str r3, [sp, #0x14]
...
.L08080842:
	...
	adds r0, #1
	strh r0, [r1]
	ldr r1, .L080808D4 @ =gUnk_0201636A
	ldrh r0, [r1]
	adds r0, #1
	strh r0, [r1]
	ldr r0, [r6, #0x54]
...
.L08080918:
	...
	b .L08080A3E
.L08080930:
	ldr r0, .L08080A04 @ =gUnk_0201636A
	ldrh r0, [r0]
	cmp r0, #0
	beq .L08080A1C
	ldr r0, [r6, #0x54]
...
.L080809AA:
	...
	subs r0, #1
	strh r0, [r4]
	ldr r1, .L08080A04 @ =gUnk_0201636A
	ldrh r0, [r1]
	subs r0, #1
	strh r0, [r1]
	adds r0, r7, #0
...
.L08080A3E:
	...
	b .L08080B60
.L08080A48:
	ldr r0, .L08080A94 @ =gUnk_0201636A
	ldrh r0, [r0]
	cmp r0, #0
	beq .L08080B3C
...
.L08080BBA:
	...
	b .L080812FA
.L08080BCE:
	ldr r0, .L08080C2C @ =gUnk_0201636A
	ldrh r0, [r0]
	adds r7, r6, #0
	adds r7, #0x2e
	movs r3, #0x50
...
.L08080D68:
	...
	adds r2, r2, r6
	mov r8, r2
	ldr r3, .L08080DD0 @ =gUnk_0201636A
	mov ip, r3
	cmp r1, #5
	bne .L08080DDC
	ldrh r1, [r2]
...
.L08081316:
	...
	b .L08081392
.L08081352:
	ldr r0, .L08081368 @ =gUnk_0201636A
	ldrh r0, [r0]
	cmp r0, #0
	bne .L0808136C
	cmp r1, #1
...
func_fe6_080823A0: @ 0x080823A0
	push {r4, lr}
	adds r3, r0, #0
	ldr r4, .L080823B4 @ =gUnk_0201636A
	ldrh r0, [r4]
	adds r2, r0, #0
	cmp r2, #0
	bne .L080823B8
...
func_fe6_08082CF4: @ 0x08082CF4
	push {lr}
	adds r1, r0, #0
	ldr r0, .L08082D04 @ =ProcScr_Prep_08679774
	bl SpawnProc
	pop {r1}
	bx r1
	.align 2, 0
.L08082D04: .4byte ProcScr_Prep_08679774
...
.L08082E34:
	...
	adds r2, r7, #0
	ands r2, r6
	ldr r3, .L08082E70 @ =Sprite_Prep_0867976C
	bl PutSpriteExt
	adds r4, #0x20
	adds r5, #1
	cmp r5, #7
...
.L08082E70: .4byte Sprite_Prep_0867976C
