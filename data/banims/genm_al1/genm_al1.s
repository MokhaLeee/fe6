...
SCR_NORMAL_ATK:
    ...
    ANIMSCR_CMD 0x2B
    ANIMSCR_FRAME 0x0C, 0x087BBF14, 0x03, OAMR_3 - OAMR
    ANIMSCR_CMD 0x24
    ANIMSCR_FRAME 0x01, 0x087BD944, 0x04, OAMR_4 - OAMR
    ANIMSCR_CMD 0x05
    ANIMSCR_FRAME 0x02, 0x087BD944, 0x04, OAMR_4 - OAMR
    ANIMSCR_FRAME 0x01, 0x087BE784, 0x05, OAMR_5 - OAMR
    ANIMSCR_CMD 0x13
    ANIMSCR_FRAME 0x04, 0x087C0244, 0x06, OAMR_6 - OAMR
    ANIMSCR_CMD 0x01
    ANIMSCR_FRAME 0x04, 0x087C0244, 0x07, OAMR_7 - OAMR
    ANIMSCR_FRAME 0x04, 0x087C0244, 0x08, OAMR_8 - OAMR
    ANIMSCR_CMD 0x1B
    ANIMSCR_CMD 0x15
    ANIMSCR_FRAME 0x0A, 0x087C0244, 0x09, OAMR_9 - OAMR
    ANIMSCR_FRAME 0x08, 0x087C0FCC, 0x0A, OAMR_10 - OAMR
    ANIMSCR_CMD 0x2B
    ANIMSCR_CMD 0x06
    ANIMSCR_FRAME 0x04, 0x087C0FCC, 0x0B, OAMR_11 - OAMR
    ANIMSCR_CMD 0x0D
    ANIMSCR_BLOCKED
...
SCR_RANGED_ATK:
    ...
    ANIMSCR_CMD 0x13
    ANIMSCR_FRAME 0x01, 0x087BE784, 0x05, OAMR_5 - OAMR
    ANIMSCR_FRAME 0x01, 0x087C0244, 0x06, OAMR_6 - OAMR
    ANIMSCR_CMD 0x01
    ANIMSCR_FRAME 0x04, 0x087C0244, 0x06, OAMR_6 - OAMR
    ANIMSCR_FRAME 0x04, 0x087C0244, 0x07, OAMR_7 - OAMR
    ANIMSCR_FRAME 0x04, 0x087C0244, 0x08, OAMR_8 - OAMR
...
SCR_RANGED_CRIT_ATK:
    ...
    ANIMSCR_FRAME 0x04, 0x087BBF14, 0x02, OAMR_2 - OAMR
    ANIMSCR_CMD 0x2B
    ANIMSCR_FRAME 0x04, 0x087C2DCC, 0x0C, OAMR_12 - OAMR
    ANIMSCR_FRAME 0x02, 0x087C2DCC, 0x0D, OAMR_13 - OAMR
    ANIMSCR_FRAME 0x01, 0x087C2DCC, 0x0E, OAMR_14 - OAMR
    ANIMSCR_FRAME 0x01, 0x087C2DCC, 0x0F, OAMR_15 - OAMR
    ANIMSCR_FRAME 0x01, 0x087C2DCC, 0x10, OAMR_16 - OAMR
    ANIMSCR_FRAME 0x01, 0x087C2DCC, 0x11, OAMR_17 - OAMR
    ANIMSCR_FRAME 0x01, 0x087C2DCC, 0x0C, OAMR_12 - OAMR
    ANIMSCR_CMD 0x22
    ANIMSCR_FRAME 0x01, 0x087C2DCC, 0x0D, OAMR_13 - OAMR
    ANIMSCR_FRAME 0x01, 0x087C2DCC, 0x0E, OAMR_14 - OAMR
    ANIMSCR_FRAME 0x01, 0x087C2DCC, 0x0F, OAMR_15 - OAMR
    ANIMSCR_FRAME 0x01, 0x087C2DCC, 0x10, OAMR_16 - OAMR
    ANIMSCR_FRAME 0x01, 0x087C2DCC, 0x11, OAMR_17 - OAMR
    ...
    ANIMSCR_FRAME 0x01, 0x087C2DCC, 0x10, OAMR_16 - OAMR
    ANIMSCR_FRAME 0x01, 0x087C2DCC, 0x11, OAMR_17 - OAMR
    ANIMSCR_FRAME 0x02, 0x087BBF14, 0x02, OAMR_2 - OAMR
    ANIMSCR_FRAME 0x10, 0x087BBF14, 0x03, OAMR_3 - OAMR
    ANIMSCR_CMD 0x24
    ANIMSCR_FRAME 0x01, 0x087BD944, 0x04, OAMR_4 - OAMR
    ANIMSCR_CMD 0x05
    ANIMSCR_FRAME 0x02, 0x087BD944, 0x04, OAMR_4 - OAMR
...
SCR_CLOSE_DODGE:
    ...
    ANIMSCR_FRAME 0x01, 0x087BBF14, 0x00, OAMR_0 - OAMR
    ANIMSCR_CMD 0x0E
    ANIMSCR_FRAME 0x03, 0x087BE784, 0x12, OAMR_18 - OAMR
    ANIMSCR_CMD 0x2B
    ANIMSCR_FRAME 0x01, 0x087BE784, 0x13, OAMR_19 - OAMR
    ANIMSCR_CMD 0x01
    ANIMSCR_FRAME 0x03, 0x087BE784, 0x12, OAMR_18 - OAMR
    ANIMSCR_CMD 0x2B
    ANIMSCR_CMD 0x0D
