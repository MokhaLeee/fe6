...
BANIM_SCR_arcm_ar1_2_NORMAL_ATK:
    ANIMSCR_FRAME 0x01, 0x086D3270, 0x00, 0x0000
    ANIMSCR_CMD 0x01
    ANIMSCR_BLOCKED

BANIM_SCR_arcm_ar1_2_NORMAL_ATK_PRIORITY_L:
    ANIMSCR_FRAME 0x01, 0x086D3270, 0x00, 0x0000
    ANIMSCR_CMD 0x01
    ANIMSCR_BLOCKED

BANIM_SCR_arcm_ar1_2_CRIT_ATK:
    ANIMSCR_FRAME 0x01, 0x086D3270, 0x00, 0x0000
    ANIMSCR_CMD 0x01
    ANIMSCR_BLOCKED

BANIM_SCR_arcm_ar1_2_CRIT_ATK_PRIORITY_L:
    ANIMSCR_FRAME 0x01, 0x086D3270, 0x00, 0x0000
    ANIMSCR_CMD 0x01
    ANIMSCR_BLOCKED

BANIM_SCR_arcm_ar1_2_RANGED_ATK:
    ANIMSCR_FRAME 0x01, 0x086D3270, 0x00, 0x0000
    ANIMSCR_CMD 0x01
    ANIMSCR_BLOCKED

BANIM_SCR_arcm_ar1_2_RANGED_CRIT_ATK:
    ANIMSCR_FRAME 0x01, 0x086D3270, 0x00, 0x0000
    ANIMSCR_CMD 0x01
    ANIMSCR_BLOCKED

BANIM_SCR_arcm_ar1_2_CLOSE_DODGE:
    ANIMSCR_CMD 0x18
    ANIMSCR_FRAME 0x01, 0x086D3270, 0x00, 0x0000
    ANIMSCR_FRAME 0x03, 0x086D3F00, 0x01, 0x0048
    ANIMSCR_FRAME 0x01, 0x086D3F00, 0x02, 0x00B4
    ANIMSCR_CMD 0x01
    ANIMSCR_FRAME 0x03, 0x086D3F00, 0x01, 0x0048
    ANIMSCR_CMD 0x0D
    ANIMSCR_BLOCKED

BANIM_SCR_arcm_ar1_2_RANGED_DODGE:
    ANIMSCR_CMD 0x18
    ANIMSCR_FRAME 0x01, 0x086D3270, 0x00, 0x0000
    ANIMSCR_FRAME 0x03, 0x086D3F00, 0x01, 0x0048
    ANIMSCR_FRAME 0x01, 0x086D3F00, 0x02, 0x00B4
...
BANIM_SCR_arcm_ar1_2_STANDING:
    ANIMSCR_FRAME 0x01, 0x086D3270, 0x00, 0x0000
    ANIMSCR_CMD 0x01
    ANIMSCR_BLOCKED

BANIM_SCR_arcm_ar1_2_STANDING2:
    ANIMSCR_FRAME 0x01, 0x086D3270, 0x00, 0x0000
    ANIMSCR_CMD 0x01
    ANIMSCR_BLOCKED

BANIM_SCR_arcm_ar1_2_RANGED_STANDING:
    ANIMSCR_FRAME 0x01, 0x086D3270, 0x00, 0x0000
    ANIMSCR_CMD 0x01
    ANIMSCR_BLOCKED

BANIM_SCR_arcm_ar1_2_MISSED_ATK:
    ANIMSCR_FRAME 0x04, 0x086D3270, 0x00, 0x0000
    ANIMSCR_BLOCKED


.section .data.modes
    .word BANIM_SCR_arcm_ar1_2_NORMAL_ATK - BANIM_SCR_arcm_ar1_2_START @ 0x0
    .word BANIM_SCR_arcm_ar1_2_NORMAL_ATK_PRIORITY_L - BANIM_SCR_arcm_ar1_2_START @ 0x14
    .word BANIM_SCR_arcm_ar1_2_CRIT_ATK - BANIM_SCR_arcm_ar1_2_START @ 0x28
    .word BANIM_SCR_arcm_ar1_2_CRIT_ATK_PRIORITY_L - BANIM_SCR_arcm_ar1_2_START @ 0x3C
    .word BANIM_SCR_arcm_ar1_2_RANGED_ATK - BANIM_SCR_arcm_ar1_2_START @ 0x50
    .word BANIM_SCR_arcm_ar1_2_RANGED_CRIT_ATK - BANIM_SCR_arcm_ar1_2_START @ 0x64
    .word BANIM_SCR_arcm_ar1_2_CLOSE_DODGE - BANIM_SCR_arcm_ar1_2_START @ 0x78
    .word BANIM_SCR_arcm_ar1_2_RANGED_DODGE - BANIM_SCR_arcm_ar1_2_START @ 0xB8
    .word BANIM_SCR_arcm_ar1_2_STANDING - BANIM_SCR_arcm_ar1_2_START @ 0xF8
    .word BANIM_SCR_arcm_ar1_2_STANDING2 - BANIM_SCR_arcm_ar1_2_START @ 0x10C
    .word BANIM_SCR_arcm_ar1_2_RANGED_STANDING - BANIM_SCR_arcm_ar1_2_START @ 0x120
    .word BANIM_SCR_arcm_ar1_2_MISSED_ATK - BANIM_SCR_arcm_ar1_2_START @ 0x134
    .word 0
    .word 0
    .word 0
    .word 0
